...
import os
import config
from utils import load_checkpoint, save_checkpoint, save_latent_distribution, save_reconstructed_images, plot_batch_latent_distribution, check_accuracy
import random
...
if True:  # use FC architectures
    ...
    writer_parameters = SummaryWriter(f"logs/AAE/FC/parameters")
    ...
    writer_parameters = SummaryWriter(f"logs/AAE/CNN/parameters")
