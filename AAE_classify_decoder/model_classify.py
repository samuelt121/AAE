...
class Decoder_FC(nn.Module):
    def __init__(self, layerDepth = 1000):
        ...
        self.classifier = nn.Sequential(
            nn.Linear(config.IMAGE_SIZE * config.IMAGE_SIZE * config.N_channels, config.NUM_CLASSES),
...
# TODO: implement deeper CNN network for better classification. current is very shallow.
